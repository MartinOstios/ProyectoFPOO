...
public class Liga {
    ...
    public void crearEquipo(String nombre, int anioFundacion, int numTitulos, int golesContra, int partidosJugados){
        Equipo nuevoEquipo = new Equipo(nombre, anioFundacion, numTitulos, golesContra, partidosJugados);
    ...
    /**
     * Tabla de posiciones de la liga, ordenar los equipos de mayor a
     * menor teniendo en cuenta la cantidad de puntos, en caso que
     * existan equipos con la misma cantidad de puntos el factor de
     * desempate corresponde a la diferencia de goles (goles a favor –
     * goles en contra)
    ...
    /**
     * Arquero que le han marcado menos goles, esta información se 
     * puede obtener de los goles en contra.
     * @return objeto de tipo Jugador
     */
